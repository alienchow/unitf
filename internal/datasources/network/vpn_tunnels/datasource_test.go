...
var testAccVpnTunnelsDataSourceConfig string

func TestAccVpnTunnelsDataSource(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config:      testAccVpnTunnelsDataSourceConfig,
