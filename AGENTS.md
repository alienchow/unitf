...
## 9. GitHub Actions & CI
*   **Latest Versions:** ALWAYS use the latest available major versions for GitHub Actions (e.g., `actions/checkout@v4`, `actions/setup-go@v5`, `golangci/golangci-lint-action@v6`). Do not hallucinate or arbitrarily downgrade action versions.
