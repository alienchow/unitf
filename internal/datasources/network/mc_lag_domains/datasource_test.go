...
var testAccMcLagDomainsDataSourceConfig string

func TestAccMcLagDomainsDataSource(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config:      testAccMcLagDomainsDataSourceConfig,
