...
var testAccDpiCategoriesDataSourceConfig string

func TestAccDpiCategoriesDataSource(t *testing.T) {
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config:      testAccDpiCategoriesDataSourceConfig,
