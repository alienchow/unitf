...
var testAccSwitchStacksDataSourceConfig string

func TestAccSwitchStacksDataSource(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config:      testAccSwitchStacksDataSourceConfig,
