...
var testAccDeviceTagsDataSourceConfig string

func TestAccDeviceTagsDataSource(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config:      testAccDeviceTagsDataSourceConfig,
