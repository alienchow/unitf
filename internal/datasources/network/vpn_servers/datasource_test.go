...
var testAccVpnServersDataSourceConfig string

func TestAccVpnServersDataSource(t *testing.T) {
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config:      testAccVpnServersDataSourceConfig,
