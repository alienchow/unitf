package device_statistics_test
...
var testAccDeviceStatisticsDataSourceConfig string

func TestAccDeviceStatisticsDataSource(t *testing.T) {
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config:      testAccDeviceStatisticsDataSourceConfig,
