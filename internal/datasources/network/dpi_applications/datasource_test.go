...
var testAccDpiApplicationsDataSourceConfig string

func TestAccDpiApplicationsDataSource(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config:      testAccDpiApplicationsDataSourceConfig,
